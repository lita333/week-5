...
window.addEventListener("load", (event) => {
  ...
  document.getElementById("alien").style.top =
    Math.random() * window.innerWidth + "px";
  document.getElementById("alien").style.left =
    Math.random() * window.innerHeight + "px";

  document.getElementById("mad").style.top =
    Math.random() * window.innerWidth + "px";
  document.getElementById("mad").style.left =
    Math.random() * window.innerHeight + "px";

  document.getElementById("kiss").style.top =
    Math.random() * window.innerWidth + "px";
  document.getElementById("kiss").style.left =
    Math.random() * window.innerHeight + "px";
});
...
document.getElementById("alien").onmousedown = drag;
document.getElementById("mad").onmousedown = drag;
document.getElementById("kiss").onmousedown = drag;
